<div align="center">
    ...
    <a href="https://www.npmjs.com/package/@tea062024/veniam-facere-voluptatum" target="_blank" title="@tea062024/veniam-facere-voluptatum - npm" style="text-decoration:none">
        <img src="https://img.shields.io/npm/dt/@tea062024/veniam-facere-voluptatum.svg?maxAge=3600" alt="npm downloads">
        <img src="https://img.shields.io/github/issues/sefinek24/@tea062024/veniam-facere-voluptatum" alt="Issues">
        <img src="https://img.shields.io/github/last-commit/sefinek24/@tea062024/veniam-facere-voluptatum" alt="Last commit">
        <img src="https://img.shields.io/github/commit-activity/w/sefinek24/@tea062024/veniam-facere-voluptatum" alt="Commit activity">
        <img src="https://img.shields.io/github/languages/code-size/sefinek24/@tea062024/veniam-facere-voluptatum" alt="Code size">
    </a>
</div>

## 📥 » Installation
```bash
npm install @tea062024/veniam-facere-voluptatum
```
...
```js
const IsInvitation = require('@tea062024/veniam-facere-voluptatum');
...
> Alternatively, you can create a new [Issue](https://github.com/tea062024/veniam-facere-voluptatum/issues/new).

## 🌿 Pull requests
Collaborators are welcome! If you'd like to contribute your suggestions or corrections to this project, we encourage you to create [Pull requests](https://github.com/tea062024/veniam-facere-voluptatum/pulls).

## ⭐ » Thanks
Thank you for your interest in this module. If you like it or find it useful, please consider starring the [repository](https://github.com/tea062024/veniam-facere-voluptatum).